  ...
  <div class="m-nav">
    <ul class="nav">
      <li class="list">
        ...
        <dl>
          <dd>
            <nuxt-link to="/dd">我的订单</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/dd">我的收藏</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/dd">抵用券</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/dd">账户设置</nuxt-link>
          </dd>
        </dl>
      </li>
      <li>
      ...
      <li class="list bd">
        <nuxt-link to="/ss">商家中心</nuxt-link>
        <dl>
          <dd>
            <nuxt-link to="/dd">登陆商家中心</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/dd">我想合作</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/dd">手机免费开店</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/dd">餐饮代理商</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/dd">商家申请开票</nuxt-link>
          </dd>
        </dl>
      </li>
      <li class="list site">
        <nuxt-link to="/mm">网站导航</nuxt-link>
